(*<*)
theory TeoriaCompacidad3
  imports Main
"/Users/fabian/Dropbox/Teorias1/ExistenciaModelos/ExistenciaModeloP"
begin
(*>*)
section \<open> Anexo 1. Teoría Compacidad \<close>
...
proof -
  ...
  satisfacible A) \<or>
    (\<forall> (A::'b formula set). (A\<subseteq> W \<union> {Comp2 F} \<and> finite A) \<longrightarrow> satisfacible A))"
    have "False"
    proof -
