...
from proyecto_isabelle.backend.dto import ExerciseResponse, ReviewRequest, ReviewResponse
...
@router.get("/pending")
def list_pending():
    exercises = get_pending_exercises()
...
def list_all(
    ...
    exercises, next_after_id = list_exercises(
