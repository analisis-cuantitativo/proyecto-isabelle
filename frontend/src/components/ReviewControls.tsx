import { Check, X, Undo2, SkipForward, SkipBack } from 'lucide-react'
...
export function ReviewControls({
  ...
  return (
    <section className="flex items-center justify-center gap-4 mt-6" aria-label="Controles de decision">
      <button
        onClick={onReject}
      ...
      <button
        onClick={onApprove}
        className="group relative flex flex-col items-center justify-center w-20 h-20 bg-white/60 dark:bg-zinc-800/60 backdrop-blur-xl border border-white/60 dark:border-white/10 rounded-full hover:border-emerald-400/50 hover:bg-emerald-50/80 dark:hover:bg-emerald-900/20 active:scale-95 transition-all duration-500 ease-out shadow-xl shadow-slate-200/50 dark:shadow-black/30 hover:shadow-emerald-500/20"
